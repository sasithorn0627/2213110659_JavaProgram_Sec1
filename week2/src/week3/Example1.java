...
public class Example1 {
	...
	public static void main(String[] args) {
		String name = JOptionPane.showInputDialog("Input Full nam:");
		...
		int gender = JOptionPane.showConfirmDialog(null,"Are you Female?,"Gender",JOptionPane.YES_NO_OPTION);JOptionPane.showMessageDialog(null,"Full name: "+name+"\nBirth year: "+birthYear+"\nYou're: "+(gender==0?"Female":"Male"));
